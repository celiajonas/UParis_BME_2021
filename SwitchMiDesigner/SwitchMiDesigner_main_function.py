...
def SwitchMiDesigner(parameters):
    ...
    len_unpaired (int): Length of the recognition sequence's region that will be unpaired to the toehold. Minimum 4
    
    len_paired (int): Length of the recognition sequence's region that will be paired to the toehold. Minimum 3
    
    output_folder (str): path to the output folder
    
    min_unpaired (int): Minimum number of unpaired residues in the secondary structure of the target mRNA for a candidate trigger to be considered
